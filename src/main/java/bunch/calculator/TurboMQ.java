 ...
 */
public final class TurboMQ implements ObjectiveFunctionCalculator {
...
//   objValue = (intraEdges / k) * (1 / exitEdges);
   ...
   if ((exitEdges+intradep) == 0)
      ...
      objValue = (intradep / (intradep+(0.5 * exitEdges)));

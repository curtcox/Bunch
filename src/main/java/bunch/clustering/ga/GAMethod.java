 ...
 * be used by the bunch.clustering.ga.ga.GAClusteringMethod.run() method to initialize the
 ...
 * be used by the bunch.clustering.ga.ga.GAClusteringMethod.run() method as upper bound
 ...
 * be used by the bunch.clustering.ga.ga.GAClusteringMethod.run() method to increment the
